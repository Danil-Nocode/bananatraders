...
class IndexTraderCopy2Widget extends StatefulWidget {
  const IndexTraderCopy2Widget({Key? key}) : super(key: key);

  @override
  _IndexTraderCopy2WidgetState createState() => _IndexTraderCopy2WidgetState();
}

class _IndexTraderCopy2WidgetState extends State<IndexTraderCopy2Widget> {
